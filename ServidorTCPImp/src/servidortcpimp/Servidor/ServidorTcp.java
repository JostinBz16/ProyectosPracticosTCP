 ...
 */
package servidortcpimp.Servidor;
...
import servidortcpimp.Vistas.VistaPrincipal;
...
public class ServidorTcp extends Thread {
    ...
    public ServidorTcp(Integer puerto, VistaPrincipal v) {
    ...
    @Override
    public void run() {
        super.run(); //To change body of generated methods, choose Tools | Templates. iniciarServicio();
        iniciarServicio();
    }
